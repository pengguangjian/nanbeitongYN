...
#import "UITextView+CQCategory.h"
...
@implementation UITextView (CQCategory)
...
+ (UIColor *)cq_defaultPlaceholderColor {
...
- (UITextView *)placeholderTextView {
    ...
    if (!textView) {
        ...
        textView.textColor = [self.class cq_defaultPlaceholderColor];
