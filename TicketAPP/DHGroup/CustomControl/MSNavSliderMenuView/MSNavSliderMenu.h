...
typedef NS_ENUM(NSInteger, MSNavSliderMenuType) {
    MSNavSliderMenuTypeTitleOnly = 0,
    MSNavSliderMenuTypeTitleAndImage
};

@protocol MSNavSliderMenuDelegate;

@class MSNavSliderMenuStyleModel;

@interface MSNavSliderMenu : UIView<UIScrollViewDelegate>
{
//@protected
    MSNavSliderMenuStyleModel *styleModel;
    
    __weak id<MSNavSliderMenuDelegate>sliderDelegate;
}

/*init*/
- (instancetype)initWithFrame:(CGRect)frame
                andStyleModel:(MSNavSliderMenuStyleModel *)styleModel
                  andDelegate:(id<MSNavSliderMenuDelegate>)delegate
                     showType:(MSNavSliderMenuType)type;

/*!
 *  @author caochun  16/02/16
 *
...
@interface MSNavSliderMenuStyleModel : NSObject
...
@protocol MSNavSliderMenuDelegate <NSObject>
